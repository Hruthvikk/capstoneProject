            ...
            <tbody>
                @foreach ($displayau as $au)
                    <tr>
                        ...
                        <td>{{ $au->userEmail }}</td>
                        <td><a href="{{ url('deleteuser', $au->id) }}" class="signinupbtndel"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
